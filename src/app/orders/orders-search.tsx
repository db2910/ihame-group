...
// Same debounced, URL-driven, server-refetch pattern as Items'/Customers'
// search — filters this staff member's own order list, which can run into
// the hundreds over time even though it's scoped to one person.
  ...
  return (
    <div className="focus-ring-brand-within flex h-11 min-w-0 flex-1 items-center gap-2 rounded border border-input-border bg-card px-3.5 md:h-[34px] md:w-[240px] md:flex-none">
      ...
      <input
        ...
        aria-label="Search orders by order number, customer or goods description"
